...
CREATE TABLE `Spot` (
  `sp_id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Product` (
  `pr_id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `pr_name` varchar(128) NOT NULL
);
ALTER TABLE `Activity`
ADD FOREIGN KEY (`us_email`) REFERENCES `User` (`us_email`);
ALTER TABLE `Activity`
ADD FOREIGN KEY (`sp_id`) REFERENCES `Spot` (`sp_id`);
ALTER TABLE `UsedProduct`
ADD FOREIGN KEY (`pr_id`) REFERENCES `Product` (`pr_id`);
ALTER TABLE `UsedProduct`
ADD FOREIGN KEY (`ac_id`) REFERENCES `Activity` (`ac_id`);